              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-1">
                ...
                <div className="flex items-center gap-2.5 shrink-0">
                  <Link
                    ...
                    className="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white font-bold text-xs sm:text-sm rounded-full shadow-xs flex items-center gap-2 transition-all hover:shadow-sm"
                  >
          ...
          <section className="space-y-4 pt-2">
            ...
            <div className="flex items-center justify-between border-b border-slate-200/80 pb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="px-2.5 py-0.5 bg-blue-50 text-blue-800 text-xs font-bold rounded-full border border-blue-200/60">
