      ...
      <div className="flex-1 flex flex-col min-w-0 h-full overflow-hidden">
        <main className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-4 pb-20 md:pb-6 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden max-w-6xl w-full mx-auto">
          ...
          <div className={`${themeConfig.cardBg} border ${themeConfig.cardBorder} shadow-xs rounded-3xl p-5 sm:p-6 space-y-3.5`}>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2.5 pt-3 border-t border-slate-100 dark:border-slate-800/80">
              {/* 1. Chuỗi dài nhất */}
              <div className="bg-slate-100/90 dark:bg-[#040814] border border-slate-200 dark:border-slate-800/90 p-3 rounded-2xl flex items-center gap-3 transition-all shadow-2xs">
                ...
                <div className="min-w-0">
                  <p className="text-sm sm:text-base font-black text-slate-900 dark:text-white leading-tight">
                    {USER_STATS.longestStreak} <span className="text-xs font-bold text-slate-700 dark:text-slate-200">ngày</span>
                  </p>
                  <p className="truncate text-[11px] text-slate-600 dark:text-slate-300 font-semibold">Chuỗi dài nhất</p>
                </div>
              </div>
              ...
              <div className="bg-slate-100/90 dark:bg-[#040814] border border-slate-200 dark:border-slate-800/90 p-3 rounded-2xl flex items-center gap-3 transition-all shadow-2xs">
                ...
                <div className="min-w-0">
                  <p className="text-sm sm:text-base font-black text-slate-900 dark:text-white leading-tight">
                    {USER_STATS.savedWords} <span className="text-xs font-bold text-slate-700 dark:text-slate-200">từ</span>
                  </p>
                  <p className="truncate text-[11px] text-slate-600 dark:text-slate-300 font-semibold">Từ đã lưu</p>
                </div>
              </div>
              ...
              <div className="bg-slate-100/90 dark:bg-[#040814] border border-slate-200 dark:border-slate-800/90 p-3 rounded-2xl flex items-center gap-3 transition-all shadow-2xs">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-[11px] text-slate-600 dark:text-slate-300 font-semibold">Thời gian luyện tập</p>
                </div>
              </div>
              ...
              <div className="bg-slate-100/90 dark:bg-[#040814] border border-slate-200 dark:border-slate-800/90 p-3 rounded-2xl flex items-center gap-3 transition-all shadow-2xs">
                ...
                <div className="min-w-0">
                  ...
                  <p className="truncate text-[11px] text-slate-600 dark:text-slate-300 font-semibold">Tổng XP</p>
                </div>
              </div>

              {/* 5. Hạng tuần */}
              <div className="bg-slate-100/90 dark:bg-[#040814] border border-slate-200 dark:border-slate-800/90 p-3 rounded-2xl flex items-center gap-3 col-span-2 sm:col-span-1 transition-all shadow-2xs">
                <div className="w-9 h-9 rounded-xl bg-amber-500/20 text-amber-500 border border-amber-500/30 flex items-center justify-center shrink-0">
                  <Trophy className="w-4.5 h-4.5" />
                </div>
                <div className="min-w-0">
                  <p className="text-sm sm:text-base font-black text-slate-900 dark:text-white leading-tight">
                    #{USER_STATS.weeklyRank} <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Tuần</span>
                  </p>
                  <p className="truncate text-[11px] text-slate-600 dark:text-slate-300 font-semibold">Hạng của bạn</p>
                </div>
              </div>
            </div>
          </div>
