        ...
        <main className="relative flex flex-col gap-6 min-h-[calc(98vh-24px)] px-4 lg:px-8 py-8 max-w-[1215px] mx-auto w-full overflow-y-auto pb-32 md:pb-16">
          ...
          <div className="w-full bg-secondary-background border-2 border-border rounded-base shadow-shadow p-4 lg:p-5 flex flex-col gap-4">
            <div className="flex items-center justify-between gap-3 flex-wrap">
              <div>
                <p className="text-xs text-foreground/60 font-heading uppercase tracking-wide">
                  Tiến độ học của bạn
                </p>
                <h2 className="text-xl lg:text-2xl font-heading">
                  Chào, <span className="bg-blue-100 px-1">Van Bui Quoc</span> 👋
                </h2>
              </div>

              <Link
                className="inline-flex items-center gap-1.5 bg-main text-main-foreground px-4 py-2 rounded-base border-2 border-border font-heading text-sm shadow-shadow hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none transition-all cursor-pointer"
                href="/review"
              >
                <svg
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
              {/* Stat 1 */}
              <div className="rounded-base border-2 border-border shadow-shadow p-3 flex flex-col gap-1 bg-yellow-100">
                <div className="flex items-center gap-1.5 text-xs font-heading text-foreground/70">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-zap h-4 w-4 text-green-700"
                    aria-hidden="true"
                  >
                ...
                <div className="text-2xl lg:text-3xl font-bold leading-none">0 / #5544</div>
                <p className="text-[11px] text-foreground/60">(Hãy cố gắng hơn nữa nhé!)</p>
              </div>

              {/* Stat 2 */}
              <div className="rounded-base border-2 border-border shadow-shadow p-3 flex flex-col gap-1 bg-emerald-100">
                <div className="flex items-center gap-1.5 text-xs font-heading text-foreground/70">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-percent h-4 w-4 text-emerald-700"
                    aria-hidden="true"
                  >
                ...
                <p className="text-[11px] text-foreground/60">0 từ</p>
              </div>

              {/* Stat 3 */}
              <Link
                className="rounded-base border-2 border-border shadow-shadow p-3 flex flex-col gap-1 bg-indigo-100 transition-all cursor-pointer hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none"
                href="/topik/lich-su"
              >
                <div className="flex items-center gap-1.5 text-xs font-heading text-foreground/70">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-file-text h-4 w-4 text-indigo-700"
                    aria-hidden="true"
                  >
                ...
                <div className="text-2xl lg:text-3xl font-bold leading-none">
                  0<span className="ml-1 text-sm font-base text-foreground/60">đề</span>
                </div>
              </Link>

              {/* Stat 4 */}
              <Link
                className="rounded-base border-2 border-border shadow-shadow p-3 flex flex-col gap-1 bg-pink-100 transition-all cursor-pointer hover:translate-x-boxShadowX hover:translate-y-boxShadowY hover:shadow-none"
                href="/topik/lich-su"
              >
                <div className="flex items-center gap-1.5 text-xs font-heading text-foreground/70">
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className="lucide lucide-award h-4 w-4 text-pink-700"
                    aria-hidden="true"
                  >
                ...
                <p className="text-[11px] text-foreground/60">(ước tính)</p>
              </Link>
            </div>
          </div>
          ...
          {/* SECTION 5: TIẾNG HÀN HỘI NHẬP (EXACT USER CODE FOR KIIP 1 & KIIP 3) */}
          <section className="flex flex-col gap-3">
