              ...
              <div className="bg-white border border-slate-200/80 shadow-xs rounded-3xl p-5 sm:p-6 shadow-xs space-y-4">
                ...
                <div className="overflow-x-auto pb-2 [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                  <div className="min-w-[680px] space-y-2">
                    <div className="grid grid-cols-26 gap-1.5">
                      {heatmapDays.map((day, idx) => {
                        ...
                        return (
                          <div
                            ...
                            className={`w-3.5 h-3.5 rounded-xs border transition-transform hover:scale-125 cursor-pointer ${levelColors[day.level]}`}
                          />
                        );
                      })}
                    </div>
                    ...
                    <div className="flex items-center justify-between text-[11px] text-slate-500 font-medium pt-2">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-[10px]">Ít học</span>
                        ...
                        <span className="text-[10px]">Chăm học</span>
                      </div>
                    </div>
                  </div>
                </div>
