...
export default function QuizMode({ cards, deckTitle }: QuizModeProps) {
  ...
  if (isCompleted || !currentCard) {
    ...
    return (
      <div className="flex flex-col items-center justify-center p-6 sm:p-8 bg-white border border-slate-200/80 shadow-xs rounded-3xl max-w-lg mx-auto text-center space-y-4 shadow-xs">
        ...
        <div className="w-full bg-slate-50 border border-slate-200/80 shadow-xs rounded-2xl p-4 space-y-1.5">
        ...
        <div className="flex items-center gap-2.5 pt-1">
          <button
            ...
            className="px-5 py-2.5 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 rounded-full border border-slate-200/80 shadow-xs shadow-xs flex items-center gap-1.5 transition-all"
          >
          ...
          <Link
            href="/"
            className="px-4 py-2.5 text-xs font-bold text-slate-800 bg-slate-100 hover:bg-slate-200 rounded-full border border-slate-200/80 shadow-xs flex items-center gap-1.5 transition-colors"
          >
  ...
  return (
    <div className="max-w-lg mx-auto space-y-3 font-sans">
      ...
      <div className="bg-white border border-slate-200/80 shadow-xs rounded-3xl p-6 text-center space-y-4 shadow-xs">
