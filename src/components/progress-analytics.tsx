    ...
    <section className="space-y-6 pt-4 border-t border-slate-200/60 dark:border-slate-800/60">
      ...
      {showHeaderAndCards && (
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
          {/* 1. Chuỗi dài nhất */}
          <div className="bg-slate-100/90 dark:bg-[#070709] border border-slate-200 dark:border-zinc-800/80 shadow-2xs rounded-2xl p-4 flex items-center gap-3 transition-all">
            ...
            <div className="min-w-0">
              <p className="text-lg font-black text-slate-900 dark:text-zinc-100 leading-tight">
                {USER_STATS.longestStreak}
                <span className="ml-1 text-xs font-bold text-slate-700 dark:text-zinc-300">ngày</span>
              </p>
          ...
          <div className="bg-slate-100/90 dark:bg-[#070709] border border-slate-200 dark:border-zinc-800/80 shadow-2xs rounded-2xl p-4 flex items-center gap-3 transition-all">
            ...
            <div className="min-w-0">
              <p className="text-lg font-black text-slate-900 dark:text-zinc-100 leading-tight">
                ...
                <span className="ml-1 text-xs font-bold text-slate-700 dark:text-zinc-300">từ</span>
              </p>
          ...
          <div className="bg-slate-100/90 dark:bg-[#070709] border border-slate-200 dark:border-zinc-800/80 shadow-2xs rounded-2xl p-4 flex items-center gap-3 transition-all">
            <div className="w-10 h-10 rounded-xl bg-blue-500/20 text-blue-500 border border-blue-500/30 flex items-center justify-center shrink-0">
          ...
          {/* 4. Tổng XP */}
          <div className="bg-slate-100/90 dark:bg-[#070709] border border-slate-200 dark:border-zinc-800/80 shadow-2xs rounded-2xl p-4 flex items-center gap-3 transition-all">
            <div className="w-10 h-10 rounded-xl bg-purple-500/20 text-purple-500 border border-purple-500/30 flex items-center justify-center shrink-0">
              <Target className="w-5 h-5" />
            </div>
            <div className="min-w-0">
              <p className="text-lg font-black text-slate-900 dark:text-zinc-100 leading-tight">
                {USER_STATS.totalXp}
                <span className="ml-1 text-xs font-black text-purple-600 dark:text-purple-400">XP</span>
              </p>
          ...
          {/* 5. Hạng của bạn */}
          <div className="bg-slate-100/90 dark:bg-[#070709] border border-slate-200 dark:border-zinc-800/80 shadow-2xs rounded-2xl p-4 flex items-center gap-3 col-span-2 sm:col-span-1 transition-all">
            <div className="w-10 h-10 rounded-xl bg-amber-500/20 text-amber-500 border border-amber-500/30 flex items-center justify-center shrink-0">
            ...
            <div className="min-w-0">
              <p className="text-lg font-black text-slate-900 dark:text-zinc-100 leading-tight">
                ...
                <span className="ml-1 text-xs font-bold text-slate-700 dark:text-zinc-300">Tuần</span>
              </p>
